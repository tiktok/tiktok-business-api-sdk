...
*js_sdk.AdApi* | [**adCreate**](docs/AdApi.md#adCreate) | **POST** /ad/create/ | Create ad. [Ad Create](https://business-api.tiktok.com/portal/docs?id=1739953377508354)
*js_sdk.AdApi* | [**adGet**](docs/AdApi.md#adGet) | **GET** /ad/get/ | Get ads. [Ad Get](https://business-api.tiktok.com/portal/docs?id=1735735588640770)
*js_sdk.AdApi* | [**adStatusUpdate**](docs/AdApi.md#adStatusUpdate) | **POST** /ad/status/update/ | Update ad status. [Ad Status Update](https://business-api.tiktok.com/portal/docs?id=1739953422970882)
*js_sdk.AdApi* | [**adUpdate**](docs/AdApi.md#adUpdate) | **POST** /ad/update/ | Update ad. [Ad Update](https://business-api.tiktok.com/portal/docs?id=1739953405142018)
...
*js_sdk.AdgroupApi* | [**adgroupCreate**](docs/AdgroupApi.md#adgroupCreate) | **POST** /adgroup/create/ | Create adgroup. [Adgroup Create](https://business-api.tiktok.com/portal/docs?id=1739499616346114)
*js_sdk.AdgroupApi* | [**adgroupGet**](docs/AdgroupApi.md#adgroupGet) | **GET** /adgroup/get/ | Get adgroups. [Adgroup Get](https://business-api.tiktok.com/portal/docs?id=1739314558673922)
...
*js_sdk.AdgroupApi* | [**adgroupStatusUpdate**](docs/AdgroupApi.md#adgroupStatusUpdate) | **POST** /adgroup/status/update/ | Update adgroup status. [Adgroup Status Update](https://business-api.tiktok.com/portal/docs?id=1739591716326402)
*js_sdk.AdgroupApi* | [**adgroupUpdate**](docs/AdgroupApi.md#adgroupUpdate) | **POST** /adgroup/update/ | Update adgroup. [Adgroup Update](https://business-api.tiktok.com/portal/docs?id=1739586761631745)
...
*js_sdk.CampaignCreationApi* | [**campaignCreate**](docs/CampaignCreationApi.md#campaignCreate) | **POST** /campaign/create/ | Create campaign. [Campaign Create](https://business-api.tiktok.com/portal/docs?id=1739318962329602)
*js_sdk.CampaignCreationApi* | [**campaignGet**](docs/CampaignCreationApi.md#campaignGet) | **GET** /campaign/get/ | Get campaigns. [Campaign Get](https://business-api.tiktok.com/portal/docs?id=1739315828649986)
*js_sdk.CampaignCreationApi* | [**campaignGmvMaxCreate**](docs/CampaignCreationApi.md#campaignGmvMaxCreate) | **POST** /campaign/gmv_max/create/ | Create GMV Max campaign [Smart Plus GMV Max Campaign Create](https://business-api.tiktok.com/portal/docs?id=1822000988713089)
*js_sdk.CampaignCreationApi* | [**campaignGmvMaxInfo**](docs/CampaignCreationApi.md#campaignGmvMaxInfo) | **GET** /campaign/gmv_max/info/ | Get GMV Max campaign info [Smart Plus GMV Max Campaign Info](https://business-api.tiktok.com/portal/docs?id=1822000968821762)
*js_sdk.CampaignCreationApi* | [**campaignGmvMaxSessionCreate**](docs/CampaignCreationApi.md#campaignGmvMaxSessionCreate) | **POST** /campaign/gmv_max/session/create/ | Create GMV Max session [Smart Plus GMV Max Session Create](https://business-api.tiktok.com/portal/docs?id=1835246967275522)
*js_sdk.CampaignCreationApi* | [**campaignGmvMaxSessionDelete**](docs/CampaignCreationApi.md#campaignGmvMaxSessionDelete) | **POST** /campaign/gmv_max/session/delete/ | Delete GMV Max session [Smart Plus GMV Max Session Delete](https://business-api.tiktok.com/portal/docs?id=1835246983475217)
*js_sdk.CampaignCreationApi* | [**campaignGmvMaxSessionGet**](docs/CampaignCreationApi.md#campaignGmvMaxSessionGet) | **GET** /campaign/gmv_max/session/get/ | Get GMV Max session info [Smart Plus GMV Max Session Get](https://business-api.tiktok.com/portal/docs?id=1835247031331842)
*js_sdk.CampaignCreationApi* | [**campaignGmvMaxSessionList**](docs/CampaignCreationApi.md#campaignGmvMaxSessionList) | **GET** /campaign/gmv_max/session/list/ | Get GMV Max session list [Smart Plus GMV Max Session List](https://business-api.tiktok.com/portal/docs?id=1835246996436162)
*js_sdk.CampaignCreationApi* | [**campaignGmvMaxSessionUpdate**](docs/CampaignCreationApi.md#campaignGmvMaxSessionUpdate) | **POST** /campaign/gmv_max/session/update/ | Update GMV Max session [Smart Plus GMV Max Session Update](https://business-api.tiktok.com/portal/docs?id=1835247009119233)
*js_sdk.CampaignCreationApi* | [**campaignGmvMaxUpdate**](docs/CampaignCreationApi.md#campaignGmvMaxUpdate) | **POST** /campaign/gmv_max/update/ | Update GMV Max campaign [Smart Plus GMV Max Campaign Update](https://business-api.tiktok.com/portal/docs?id=1822001009002497)
*js_sdk.CampaignCreationApi* | [**campaignStatusUpdate**](docs/CampaignCreationApi.md#campaignStatusUpdate) | **POST** /campaign/status/update/ | Update campaign status. [Campaign Status Update](https://business-api.tiktok.com/portal/docs?id=1739320994354178)
*js_sdk.CampaignCreationApi* | [**campaignUpdate**](docs/CampaignCreationApi.md#campaignUpdate) | **POST** /campaign/update/ | Update campaign. [Campaign Update](https://business-api.tiktok.com/portal/docs?id=1739320422086657)
*js_sdk.CampaignCreationApi* | [**gmvMaxBidRecommend**](docs/CampaignCreationApi.md#gmvMaxBidRecommend) | **GET** /gmv_max/bid/recommend/ | Get GMV Max bid recommendation [Smart Plus GMV Max Bid Recommend](https://business-api.tiktok.com/portal/docs?id=1822001024720897)
*js_sdk.CampaignCreationApi* | [**gmvMaxCustomAnchorVideoListGet**](docs/CampaignCreationApi.md#gmvMaxCustomAnchorVideoListGet) | **GET** /gmv_max/custom_anchor_video_list/get/ | Get GMV Max custom anchor video list [Smart Plus GMV Max Custom Anchor Video List Get](https://business-api.tiktok.com/portal/docs?id=1830215925061633)
*js_sdk.CampaignCreationApi* | [**gmvMaxOccupiedCustomShopAdsList**](docs/CampaignCreationApi.md#gmvMaxOccupiedCustomShopAdsList) | **GET** /gmv_max/occupied_custom_shop_ads/list/ | Get GMV Max occupied custom shop ads [Smart Plus GMV Max Occupied Custom Shop Ads List](https://business-api.tiktok.com/portal/docs?id=1822001136924674)
...
*js_sdk.IdentityApi* | [**gmvMaxIdentityGet**](docs/IdentityApi.md#gmvMaxIdentityGet) | **GET** /gmv_max/identity/get/ | Get GMV Max identity info [Smart Plus GMV Max Identity Get](https://business-api.tiktok.com/portal/docs?id=1822001101474882)
...
*js_sdk.ReportingApi* | [**gmvMaxReportGet**](docs/ReportingApi.md#gmvMaxReportGet) | **GET** /gmv_max/report/get/ | Get GMV Max report [Smart Plus GMV Max Report Get](https://business-api.tiktok.com/portal/docs?id=1824721673497601)
...
*js_sdk.StoreApi* | [**gmvMaxExclusiveAuthorizationCreate**](docs/StoreApi.md#gmvMaxExclusiveAuthorizationCreate) | **POST** /gmv_max/exclusive_authorization/create/ | Create GMV Max exclusive authorization [Smart Plus GMV Max Exclusive Authorization Create](https://business-api.tiktok.com/portal/docs?id=1822001200356354)
*js_sdk.StoreApi* | [**gmvMaxExclusiveAuthorizationGet**](docs/StoreApi.md#gmvMaxExclusiveAuthorizationGet) | **GET** /gmv_max/exclusive_authorization/get/ | Get GMV Max exclusive authorization [Smart Plus GMV Max Exclusive Authorization Get](https://business-api.tiktok.com/portal/docs?id=1822001184635905)
*js_sdk.StoreApi* | [**gmvMaxStoreList**](docs/StoreApi.md#gmvMaxStoreList) | **GET** /gmv_max/store/list/ | Get GMV Max store list [Smart Plus GMV Max Store List](https://business-api.tiktok.com/portal/docs?id=1822001044479041)
*js_sdk.StoreApi* | [**gmvMaxStoreShopAdUsageCheck**](docs/StoreApi.md#gmvMaxStoreShopAdUsageCheck) | **GET** /gmv_max/store/shop_ad_usage_check/ | Check GMV Max shop ad usage [Smart Plus GMV Max Shop Ad Usage Check](https://business-api.tiktok.com/portal/docs?id=1822001084174338)
...
*js_sdk.ToolApi* | [**toolDiagnosisSearchHealth**](docs/ToolApi.md#toolDiagnosisSearchHealth) | **GET** /tool/diagnosis/search/health/ | Get Search Ads Campaign Health diagnoses [Tool Diagnosis Search Health](https://business-api.tiktok.com/portal/docs?id=1848591212970082)
...
*js_sdk.VideoApi* | [**gmvMaxVideoGet**](docs/VideoApi.md#gmvMaxVideoGet) | **GET** /gmv_max/video/get/ | Get GMV Max video info [Smart Plus GMV Max Video Get](https://business-api.tiktok.com/portal/docs?id=1822001168512129)
...
## Documentation for Models
 ...
 - [js_sdk.AdcreateDeeplinkUtmParams](docs/AdcreateDeeplinkUtmParams.md)
 ...
 - [js_sdk.AdcreateShowcaseProducts](docs/AdcreateShowcaseProducts.md)
 - [js_sdk.AdcreateUtmParams](docs/AdcreateUtmParams.md)
 ...
 - [js_sdk.AdgroupcreateAppConfig](docs/AdgroupcreateAppConfig.md)
 ...
 - [js_sdk.AdgroupcreateSearchKeywords](docs/AdgroupcreateSearchKeywords.md)
 - [js_sdk.AdgroupupdateSearchKeywords](docs/AdgroupupdateSearchKeywords.md)
 - [js_sdk.AdgroupupdateTargetingExpansion](docs/AdgroupupdateTargetingExpansion.md)
 ...
 - [js_sdk.CampaigngmvMaxcreateCustomAnchorVideoList](docs/CampaigngmvMaxcreateCustomAnchorVideoList.md)
 - [js_sdk.CampaigngmvMaxcreateCustomAnchorVideoListIdentityInfo](docs/CampaigngmvMaxcreateCustomAnchorVideoListIdentityInfo.md)
 - [js_sdk.CampaigngmvMaxcreateIdentityList](docs/CampaigngmvMaxcreateIdentityList.md)
 - [js_sdk.CampaigngmvMaxcreateItemList](docs/CampaigngmvMaxcreateItemList.md)
 - [js_sdk.CampaigngmvMaxcreateItemListIdentityInfo](docs/CampaigngmvMaxcreateItemListIdentityInfo.md)
 - [js_sdk.CampaigngmvMaxcreatePromotionDays](docs/CampaigngmvMaxcreatePromotionDays.md)
 - [js_sdk.CampaigngmvMaxcreatePromotionDaysCustomScheduleList](docs/CampaigngmvMaxcreatePromotionDaysCustomScheduleList.md)
 - [js_sdk.CampaigngmvMaxcreateVideoInfo](docs/CampaigngmvMaxcreateVideoInfo.md)
 - [js_sdk.CampaigngmvMaxsessioncreateSession](docs/CampaigngmvMaxsessioncreateSession.md)
 - [js_sdk.CampaigngmvMaxsessioncreateSessionProductList](docs/CampaigngmvMaxsessioncreateSessionProductList.md)
 - [js_sdk.CampaigngmvMaxsessionupdateSession](docs/CampaigngmvMaxsessionupdateSession.md)
 - [js_sdk.CampaigngmvMaxupdateCustomAnchorVideoList](docs/CampaigngmvMaxupdateCustomAnchorVideoList.md)
 - [js_sdk.CampaigngmvMaxupdateCustomAnchorVideoListIdentityInfo](docs/CampaigngmvMaxupdateCustomAnchorVideoListIdentityInfo.md)
 - [js_sdk.CampaigngmvMaxupdateItemList](docs/CampaigngmvMaxupdateItemList.md)
 - [js_sdk.CampaigngmvMaxupdateItemListIdentityInfo](docs/CampaigngmvMaxupdateItemListIdentityInfo.md)
 - [js_sdk.CampaigngmvMaxupdatePromotionDays](docs/CampaigngmvMaxupdatePromotionDays.md)
 - [js_sdk.CampaigngmvMaxupdatePromotionDaysCustomScheduleList](docs/CampaigngmvMaxupdatePromotionDaysCustomScheduleList.md)
 - [js_sdk.CampaigngmvMaxupdateVideoInfo](docs/CampaigngmvMaxupdateVideoInfo.md)
 ...
 - [js_sdk.ContextInfoGmvMaxReportGet](docs/ContextInfoGmvMaxReportGet.md)
 ...
 - [js_sdk.CustomAnchorVideoList](docs/CustomAnchorVideoList.md)
 ...
 - [js_sdk.ExclusiveAuthorizationCreateBody](docs/ExclusiveAuthorizationCreateBody.md)
 ...
 - [js_sdk.FilteringGmvMaxReportGet](docs/FilteringGmvMaxReportGet.md)
 ...
 - [js_sdk.GmvMaxCreateBody](docs/GmvMaxCreateBody.md)
 - [js_sdk.GmvMaxUpdateBody](docs/GmvMaxUpdateBody.md)
 - [js_sdk.GmvMaxcustomAnchorVideoListgetIdentityInfo](docs/GmvMaxcustomAnchorVideoListgetIdentityInfo.md)
 - [js_sdk.IdentityCreateBody](docs/IdentityCreateBody.md)
 - [js_sdk.IdentityList](docs/IdentityList.md)
 ...
 - [js_sdk.SessionCreateBody](docs/SessionCreateBody.md)
 - [js_sdk.SessionDeleteBody](docs/SessionDeleteBody.md)
 - [js_sdk.SessionUpdateBody](docs/SessionUpdateBody.md)
