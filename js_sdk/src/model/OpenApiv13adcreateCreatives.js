 ...
 * @module model/OpenApiv13adcreateCreatives
 * @version 0.1.1
 */
export class OpenApiv13adcreateCreatives {
  /**
   * Constructs a new <code>OpenApiv13adcreateCreatives</code>.
   * @alias module:model/OpenApiv13adcreateCreatives
   * @class
   */
  constructor() {
  }
  ...
  /**
   * Constructs a <code>OpenApiv13adcreateCreatives</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OpenApiv13adcreateCreatives} obj Optional instance to populate.
   * @return {module:model/OpenApiv13adcreateCreatives} The populated <code>OpenApiv13adcreateCreatives</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new OpenApiv13adcreateCreatives();
      ...
      if (data.hasOwnProperty('shopping_ads_word_set'))
        obj.shopping_ads_word_set = ApiClient.convertToType(data['shopping_ads_word_set'], ['Number']);
 ...
 */
OpenApiv13adcreateCreatives.prototype.ad_format = undefined;
 ...
 */
OpenApiv13adcreateCreatives.prototype.ad_name = undefined;
 ...
 */
OpenApiv13adcreateCreatives.prototype.ad_text = undefined;
 ...
 */
OpenApiv13adcreateCreatives.prototype.app_name = undefined;
 ...
 */
OpenApiv13adcreateCreatives.prototype.avatar_icon_web_uri = undefined;
 ...
 */
OpenApiv13adcreateCreatives.prototype.brand_safety_postbid_partner = undefined;
 ...
 */
OpenApiv13adcreateCreatives.prototype.brand_safety_vast_url = undefined;
 ...
 */
OpenApiv13adcreateCreatives.prototype.call_to_action = undefined;
 ...
 */
OpenApiv13adcreateCreatives.prototype.call_to_action_id = undefined;
 ...
 */
OpenApiv13adcreateCreatives.prototype.card_id = undefined;

/**
 * Required if card_type=IMAGE
 * @member {String} card_image_id
 */
OpenApiv13adcreateCreatives.prototype.card_image_id = undefined;
 ...
 */
OpenApiv13adcreateCreatives.prototype.card_image_index = undefined;

/**
 * Whether to show price on card or not
 * @member {Boolean} card_show_price
 */
OpenApiv13adcreateCreatives.prototype.card_show_price = undefined;

/**
 * Enum values- `BRAND`,  `DESC`. Max size = 2.
 * @member {Array.<String>} card_tags
 */
OpenApiv13adcreateCreatives.prototype.card_tags = undefined;

/**
 * Enum values- `IMAGE`, `PRODUCT`
 * @member {String} card_type
 */
OpenApiv13adcreateCreatives.prototype.card_type = undefined;
 ...
 */
OpenApiv13adcreateCreatives.prototype.catalog_id = undefined;

/**
 * Click monitoring URL. Currently Pangle does not support DCM, Sizmek or Flashtalking.
 * @member {String} click_tracking_url
 */
OpenApiv13adcreateCreatives.prototype.click_tracking_url = undefined;
 ...
 */
OpenApiv13adcreateCreatives.prototype.creative_authorized = undefined;
 ...
 */
OpenApiv13adcreateCreatives.prototype.creative_type = undefined;
 ...
 */
OpenApiv13adcreateCreatives.prototype.dark_post_status = undefined;
 ...
 */
OpenApiv13adcreateCreatives.prototype.deeplink = undefined;
 ...
 */
OpenApiv13adcreateCreatives.prototype.deeplink_type = undefined;
 ...
 */
OpenApiv13adcreateCreatives.prototype.disclaimer_clickable_texts = undefined;

/**
 * @member {module:model/OpenApiv13adcreateDisclaimerText} disclaimer_text
 */
OpenApiv13adcreateCreatives.prototype.disclaimer_text = undefined;
 ...
 */
OpenApiv13adcreateCreatives.prototype.disclaimer_type = undefined;
 ...
 */
OpenApiv13adcreateCreatives.prototype.display_name = undefined;

/**
 * Enum values- `UNSET`, `DLP`(Dynamic Landing Page)
 * @member {String} dynamic_destination
 */
OpenApiv13adcreateCreatives.prototype.dynamic_destination = undefined;

/**
 * Enum values- `UNSET`, `DYNAMIC_CREATIVE`(smart creative).
 * @member {String} dynamic_format
 */
OpenApiv13adcreateCreatives.prototype.dynamic_format = undefined;
 ...
 */
OpenApiv13adcreateCreatives.prototype.fallback_type = undefined;
 ...
 */
OpenApiv13adcreateCreatives.prototype.identity_authorized_bc_id = undefined;
 ...
 */
OpenApiv13adcreateCreatives.prototype.identity_id = undefined;
 ...
 */
OpenApiv13adcreateCreatives.prototype.identity_type = undefined;
 ...
 */
OpenApiv13adcreateCreatives.prototype.image_ids = undefined;

/**
 * Display monitoring URL
 * @member {String} impression_tracking_url
 */
OpenApiv13adcreateCreatives.prototype.impression_tracking_url = undefined;
 ...
 */
OpenApiv13adcreateCreatives.prototype.instant_product_page_used = undefined;
 ...
 */
OpenApiv13adcreateCreatives.prototype.item_duet_status = undefined;

/**
 * Product SPU ID
 * @member {Array.<String>} item_group_ids
 */
OpenApiv13adcreateCreatives.prototype.item_group_ids = undefined;
 ...
 */
OpenApiv13adcreateCreatives.prototype.item_stitch_status = undefined;

/**
 * Landing page URL.
 * @member {String} landing_page_url
 */
OpenApiv13adcreateCreatives.prototype.landing_page_url = undefined;
 ...
 */
OpenApiv13adcreateCreatives.prototype.operation_status = undefined;
 ...
 */
OpenApiv13adcreateCreatives.prototype.page_id = undefined;

/**
 * The index of page.
 * @member {Number} page_image_index
 */
OpenApiv13adcreateCreatives.prototype.page_image_index = undefined;
 ...
 */
OpenApiv13adcreateCreatives.prototype.playable_url = undefined;

/**
 * The ID of the product set.
 * @member {String} product_set_id
 */
OpenApiv13adcreateCreatives.prototype.product_set_id = undefined;
 ...
 */
OpenApiv13adcreateCreatives.prototype.product_specific_type = undefined;
 ...
 */
OpenApiv13adcreateCreatives.prototype.promotional_music_disabled = undefined;
 ...
 */
OpenApiv13adcreateCreatives.prototype.shopping_ads_deeplink_type = undefined;
 ...
 */
OpenApiv13adcreateCreatives.prototype.shopping_ads_fallback_type = undefined;
 ...
 */
OpenApiv13adcreateCreatives.prototype.shopping_ads_video_package_id = undefined;

/**
 * Shopping Ads word set
 * @member {Array.<Number>} shopping_ads_word_set
 */
OpenApiv13adcreateCreatives.prototype.shopping_ads_word_set = undefined;

/**
 * IDs of the SKUs
 * @member {Array.<String>} sku_ids
 */
OpenApiv13adcreateCreatives.prototype.sku_ids = undefined;
 ...
 */
OpenApiv13adcreateCreatives.prototype.tiktok_item_id = undefined;
 ...
 */
OpenApiv13adcreateCreatives.prototype.tracking_pixel_id = undefined;
 ...
 */
OpenApiv13adcreateCreatives.prototype.vast_moat_enabled = undefined;

/**
 * @member {String} vertical_video_strategy
 */
OpenApiv13adcreateCreatives.prototype.vertical_video_strategy = undefined;
 ...
 */
OpenApiv13adcreateCreatives.prototype.video_id = undefined;

/**
 * The monitoring URL for video view.
 * @member {String} video_view_tracking_url
 */
OpenApiv13adcreateCreatives.prototype.video_view_tracking_url = undefined;
 ...
 */
OpenApiv13adcreateCreatives.prototype.viewability_postbid_partner = undefined;
 ...
 */
OpenApiv13adcreateCreatives.prototype.viewability_vast_url = undefined;
