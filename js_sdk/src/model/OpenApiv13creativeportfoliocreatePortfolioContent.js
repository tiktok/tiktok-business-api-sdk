...
export class OpenApiv13creativeportfoliocreatePortfolioContent {
  /**
   * Constructs a new <code>OpenApiv13creativeportfoliocreatePortfolioContent</code>.
   * The content of the portfolio
   * @alias module:model/OpenApiv13creativeportfoliocreatePortfolioContent
   * @class
   */
  constructor() {
  }
  ...
  /**
   * Constructs a <code>OpenApiv13creativeportfoliocreatePortfolioContent</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OpenApiv13creativeportfoliocreatePortfolioContent} obj Optional instance to populate.
   * @return {module:model/OpenApiv13creativeportfoliocreatePortfolioContent} The populated <code>OpenApiv13creativeportfoliocreatePortfolioContent</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new OpenApiv13creativeportfoliocreatePortfolioContent();
      if (data.hasOwnProperty('advanced_audio_info'))
        obj.advanced_audio_info = OpenApiv13creativeportfoliocreateAdvancedAudioInfo.constructFromObject(data['advanced_audio_info']);
      if (data.hasOwnProperty('advanced_gesture_icon'))
        obj.advanced_gesture_icon = OpenApiv13creativeportfoliocreateAdvancedGestureIcon.constructFromObject(data['advanced_gesture_icon']);
      if (data.hasOwnProperty('advanced_gesture_image'))
        obj.advanced_gesture_image = OpenApiv13creativeportfoliocreateAdvancedGestureIcon.constructFromObject(data['advanced_gesture_image']);
      ...
      if (data.hasOwnProperty('badge_image_info'))
        obj.badge_image_info = OpenApiv13creativeportfoliocreateBadgeImageInfo.constructFromObject(data['badge_image_info']);
      ...
      if (data.hasOwnProperty('badge_position'))
        obj.badge_position = OpenApiv13creativeportfoliocreateBadgePosition.constructFromObject(data['badge_position']);
      ...
      if (data.hasOwnProperty('sticker_param'))
        obj.sticker_param = OpenApiv13creativeportfoliocreateStickerParam.constructFromObject(data['sticker_param']);
...
/**
 * @member {module:model/OpenApiv13creativeportfoliocreateAdvancedAudioInfo} advanced_audio_info
 */
OpenApiv13creativeportfoliocreatePortfolioContent.prototype.advanced_audio_info = undefined;

/**
 * @member {module:model/OpenApiv13creativeportfoliocreateAdvancedGestureIcon} advanced_gesture_icon
 */
OpenApiv13creativeportfoliocreatePortfolioContent.prototype.advanced_gesture_icon = undefined;

/**
 * @member {module:model/OpenApiv13creativeportfoliocreateAdvancedGestureIcon} advanced_gesture_image
 */
OpenApiv13creativeportfoliocreatePortfolioContent.prototype.advanced_gesture_image = undefined;

/**
 * The call-to-action text that will be shown below the image/badge
 * @member {String} call_to_action_text
 */
OpenApiv13creativeportfoliocreatePortfolioContent.prototype.call_to_action_text = undefined;

/**
 * @member {module:model/OpenApiv13creativeportfoliocreateBadgeImageInfo} badge_image_info
 */
OpenApiv13creativeportfoliocreatePortfolioContent.prototype.badge_image_info = undefined;

/**
 * @member {String} advanced_interact_shape
 */
OpenApiv13creativeportfoliocreatePortfolioContent.prototype.advanced_interact_shape = undefined;

/**
 * @member {String} advanced_interact_type
 */
OpenApiv13creativeportfoliocreatePortfolioContent.prototype.advanced_interact_type = undefined;

/**
 * @member {module:model/OpenApiv13creativeportfoliocreateBadgePosition} badge_position
 */
OpenApiv13creativeportfoliocreatePortfolioContent.prototype.badge_position = undefined;
 ...
 */
OpenApiv13creativeportfoliocreatePortfolioContent.prototype.badge_show_time = undefined;
 ...
 */
OpenApiv13creativeportfoliocreatePortfolioContent.prototype.app_id = undefined;
 ...
 */
OpenApiv13creativeportfoliocreatePortfolioContent.prototype.asset_content = undefined;
 ...
 */
OpenApiv13creativeportfoliocreatePortfolioContent.prototype.asset_ids = undefined;

/**
 * Required when `creative_portfolio_type`= `DOWNLOAD_CARD`. Profile image URL
 * @member {String} profile_image
 */
OpenApiv13creativeportfoliocreatePortfolioContent.prototype.profile_image = undefined;
 ...
 */
OpenApiv13creativeportfoliocreatePortfolioContent.prototype.category_label = undefined;
 ...
 */
OpenApiv13creativeportfoliocreatePortfolioContent.prototype.country_code = undefined;

/**
 * Required when `creative_portfolio_type`= `DOWNLOAD_CARD`. Call-to-action text in the Download Card
 * @member {String} call_to_action
 */
OpenApiv13creativeportfoliocreatePortfolioContent.prototype.call_to_action = undefined;
 ...
 */
OpenApiv13creativeportfoliocreatePortfolioContent.prototype.description = undefined;

/**
 * Image ID. Required when `creative_portfolio_type` is `CARD`
 * @member {String} image_id
 */
OpenApiv13creativeportfoliocreatePortfolioContent.prototype.image_id = undefined;
 ...
 */
OpenApiv13creativeportfoliocreatePortfolioContent.prototype.layouts = undefined;
 ...
 */
OpenApiv13creativeportfoliocreatePortfolioContent.prototype.mobile_app_id = undefined;
 ...
 */
OpenApiv13creativeportfoliocreatePortfolioContent.prototype.product_source = undefined;

/**
 * Required when `creative_portfolio_type`= `PRODUCT_CARD`. Identity ID
 * @member {String} identity_id
 */
OpenApiv13creativeportfoliocreatePortfolioContent.prototype.identity_id = undefined;
 ...
 */
OpenApiv13creativeportfoliocreatePortfolioContent.prototype.identity_type = undefined;
 ...
 */
OpenApiv13creativeportfoliocreatePortfolioContent.prototype.identity_authorized_bc_id = undefined;
 ...
 */
OpenApiv13creativeportfoliocreatePortfolioContent.prototype.catalog_id = undefined;
 ...
 */
OpenApiv13creativeportfoliocreatePortfolioContent.prototype.catalog_authorized_bc_id = undefined;
 ...
 */
OpenApiv13creativeportfoliocreatePortfolioContent.prototype.store_id = undefined;
 ...
 */
OpenApiv13creativeportfoliocreatePortfolioContent.prototype.store_authorized_bc_id = undefined;
 ...
 */
OpenApiv13creativeportfoliocreatePortfolioContent.prototype.product_specific_type = undefined;
 ...
 */
OpenApiv13creativeportfoliocreatePortfolioContent.prototype.product_set_id = undefined;
 ...
 */
OpenApiv13creativeportfoliocreatePortfolioContent.prototype.dynamic_format = undefined;
 ...
 */
OpenApiv13creativeportfoliocreatePortfolioContent.prototype.vertical_video_strategy = undefined;
 ...
 */
OpenApiv13creativeportfoliocreatePortfolioContent.prototype.ad_text = undefined;
 ...
 */
OpenApiv13creativeportfoliocreatePortfolioContent.prototype.card_show_price = undefined;
 ...
 */
OpenApiv13creativeportfoliocreatePortfolioContent.prototype.card_image_index = undefined;
 ...
 */
OpenApiv13creativeportfoliocreatePortfolioContent.prototype.card_tags = undefined;
 ...
 */
OpenApiv13creativeportfoliocreatePortfolioContent.prototype.item_group_ids = undefined;

/**
 *  Required when `creative_portfolio_type`is `PRODUCT_CARD` and `product_source` is set as `STORE`. When `creative_portfolio_type`= `PRODUCT_CARD` and `product_specific_type` = PRODUCT_SET, you need to pass in either `product_set_id` or `item_group_ids`. Product SPU IDs. Max size: 20. Note: If you have created a Product Card and want to use it during ad creation, ensure that at the ad level you pass to the same field the value that is used for creating the Product Card. Otherwise, when the ad is delivered, the product thumbnail in the Product Card may not be of the promoted product
 * @member {Array.<String>} sku_ids
 */
OpenApiv13creativeportfoliocreatePortfolioContent.prototype.sku_ids = undefined;

/**
 * @member {module:model/OpenApiv13creativeportfoliocreateStickerParam} sticker_param
 */
OpenApiv13creativeportfoliocreatePortfolioContent.prototype.sticker_param = undefined;
 ...
 */
OpenApiv13creativeportfoliocreatePortfolioContent.prototype.tags = undefined;
 ...
 */
OpenApiv13creativeportfoliocreatePortfolioContent.prototype.card_type = undefined;
