...
import {CampaigngmvMaxcreateItemListIdentityInfo} from './CampaigngmvMaxcreateItemListIdentityInfo.js';
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('identity_info'))
        obj.identity_info = CampaigngmvMaxcreateItemListIdentityInfo.constructFromObject(data['identity_info']);
...
/**
 * @member {module:model/CampaigngmvMaxcreateItemListIdentityInfo} identity_info
 */
