  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('audience_rule'))
        obj.audience_rule = OpenApiv13adgroupupdateAudienceRule.constructFromObject(data['audience_rule']);
...
/**
 * @member {module:model/OpenApiv13adgroupupdateAudienceRule} audience_rule
 */
