 ...
 * @version 0.1.8
 */
export class DmpcustomAudiencerulecreateRuleSpecInclusionRuleSetFilterSetParameterFilters {
  /**
   * Constructs a new <code>DmpcustomAudiencerulecreateRuleSpecInclusionRuleSetFilterSetParameterFilters</code>.
   * @alias module:model/DmpcustomAudiencerulecreateRuleSpecInclusionRuleSetFilterSetParameterFilters
   * @class
  ...
  /**
   * Constructs a <code>DmpcustomAudiencerulecreateRuleSpecInclusionRuleSetFilterSetParameterFilters</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DmpcustomAudiencerulecreateRuleSpecInclusionRuleSetFilterSetParameterFilters} obj Optional instance to populate.
   * @return {module:model/DmpcustomAudiencerulecreateRuleSpecInclusionRuleSetFilterSetParameterFilters} The populated <code>DmpcustomAudiencerulecreateRuleSpecInclusionRuleSetFilterSetParameterFilters</code> instance.
   */
 ...
 * @member {String} field
 */
DmpcustomAudiencerulecreateRuleSpecInclusionRuleSetFilterSetParameterFilters.prototype.field = undefined;

/**
 * Required when parameter_filters within inclusion_rule_set is passed. Filter operator between filter condition and filter value. Enum value: CONTAINS: contains. DOES_NOT_CONTAIN: doesn't contain. EQ: equals. IS_LESS_THAN: is less than. IS_GREATER_THAN: is greater than. IS_LESS_THAN_OR_EQUAL_TO: is less than or equal to. IS_GRETER_THAN_OR_EQUAL_TO: is greater than or equal to. The allowed values vary based on the field value: If field is set to URL, operator can only be set to CONTAINS, DOES_NOT_CONTAIN, or EQ. If field is not set to URL, operator can be set to CONTAINS, DOES_NOT_CONTAINS, EQ, IS_LESS_THAN, IS_GREATER_THAN, IS_LESS_THAN_OR_EQUAL_TO, or IS_GREATER_THAN_OR_EQUAL_TO.
 * @member {String} operator
 */
DmpcustomAudiencerulecreateRuleSpecInclusionRuleSetFilterSetParameterFilters.prototype.operator = undefined;
 ...
 */
DmpcustomAudiencerulecreateRuleSpecInclusionRuleSetFilterSetParameterFilters.prototype.values = undefined;
