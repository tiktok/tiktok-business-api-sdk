...
import {CampaigngmvMaxupdateCustomAnchorVideoList} from './CampaigngmvMaxupdateCustomAnchorVideoList.js';
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('custom_anchor_video_list'))
        obj.custom_anchor_video_list = ApiClient.convertToType(data['custom_anchor_video_list'], [CampaigngmvMaxupdateCustomAnchorVideoList]);
...
/**
 * @member {Array.<module:model/CampaigngmvMaxupdateCustomAnchorVideoList>} custom_anchor_video_list
 */
