...
import {CampaigngmvMaxupdateIdentityInfo} from './CampaigngmvMaxupdateIdentityInfo.js';
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('identity_info'))
        obj.identity_info = CampaigngmvMaxupdateIdentityInfo.constructFromObject(data['identity_info']);
...
/**
 * @member {module:model/CampaigngmvMaxupdateIdentityInfo} identity_info
 */
