...
/**
 * The OpenApiv13creativeportfoliocreateStickerParam model module.
 * @module model/OpenApiv13creativeportfoliocreateStickerParam
 * @version 0.1.1
 */
export class OpenApiv13creativeportfoliocreateStickerParam {
  /**
   * Constructs a new <code>OpenApiv13creativeportfoliocreateStickerParam</code>.
   ...
   * @alias module:model/OpenApiv13creativeportfoliocreateStickerParam
   * @class
   */
  constructor() {
  }
  ...
  /**
   * Constructs a <code>OpenApiv13creativeportfoliocreateStickerParam</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OpenApiv13creativeportfoliocreateStickerParam} obj Optional instance to populate.
   * @return {module:model/OpenApiv13creativeportfoliocreateStickerParam} The populated <code>OpenApiv13creativeportfoliocreateStickerParam</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new OpenApiv13creativeportfoliocreateStickerParam();
 ...
 * @member {String} color
 */
OpenApiv13creativeportfoliocreateStickerParam.prototype.color = undefined;
 ...
 */
OpenApiv13creativeportfoliocreateStickerParam.prototype.cutoff_time = undefined;
 ...
 */
OpenApiv13creativeportfoliocreateStickerParam.prototype.display_angle = undefined;
 ...
 */
OpenApiv13creativeportfoliocreateStickerParam.prototype.landing_page_url = undefined;
 ...
 */
OpenApiv13creativeportfoliocreateStickerParam.prototype.live_tiktok_user_id = undefined;
 ...
 */
OpenApiv13creativeportfoliocreateStickerParam.prototype.opacity = undefined;

/**
 * The x-axis coordinate relative to the top-left corner of the screen. Value range: 50-109
 * @member {Number} position_x
 */
OpenApiv13creativeportfoliocreateStickerParam.prototype.position_x = undefined;

/**
 * The y-axis coordinate relative to the top-left corner of the screen. Value range: 141-506
 * @member {Number} position_y
 */
OpenApiv13creativeportfoliocreateStickerParam.prototype.position_y = undefined;
 ...
 */
OpenApiv13creativeportfoliocreateStickerParam.prototype.reminder_time = undefined;

/**
 * @member {String} size
 */
OpenApiv13creativeportfoliocreateStickerParam.prototype.size = undefined;
 ...
 */
OpenApiv13creativeportfoliocreateStickerParam.prototype.sticker_type = undefined;
 ...
 * @member {String} title
 */
OpenApiv13creativeportfoliocreateStickerParam.prototype.title = undefined;
