...
export class ContextInfoSmartPlusAdReviewInfo {
  /**
   * Constructs a new <code>ContextInfoSmartPlusAdReviewInfo</code>.
   * @alias module:model/ContextInfoSmartPlusAdReviewInfo
   * @class
   */
  constructor() {
  }
  ...
  /**
   * Constructs a <code>ContextInfoSmartPlusAdReviewInfo</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ContextInfoSmartPlusAdReviewInfo} obj Optional instance to populate.
   * @return {module:model/ContextInfoSmartPlusAdReviewInfo} The populated <code>ContextInfoSmartPlusAdReviewInfo</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new ContextInfoSmartPlusAdReviewInfo();
 ...
 */
ContextInfoSmartPlusAdReviewInfo.prototype.app_id = undefined;

/**
 * @member {Number} core_user_id
 */
ContextInfoSmartPlusAdReviewInfo.prototype.core_user_id = undefined;

/**
 * @member {Number} developer_id
 */
ContextInfoSmartPlusAdReviewInfo.prototype.developer_id = undefined;

/**
 * @member {String} developer_region
 */
ContextInfoSmartPlusAdReviewInfo.prototype.developer_region = undefined;

/**
 * @member {String} referer
 */
ContextInfoSmartPlusAdReviewInfo.prototype.referer = undefined;

/**
 * @member {String} user_agent
 */
ContextInfoSmartPlusAdReviewInfo.prototype.user_agent = undefined;

/**
 * @member {String} x_forwarded_for
 */
ContextInfoSmartPlusAdReviewInfo.prototype.x_forwarded_for = undefined;

/**
 * @member {String} x_real_ip
 */
ContextInfoSmartPlusAdReviewInfo.prototype.x_real_ip = undefined;
