...
export class AdAcoBody {
   ...
   * @param {module:model/AdAcoBody} obj Optional instance to populate.
   * @return {module:model/AdAcoBody} The populated <code>AdAcoBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new AdAcoBody();
 ...
 */
AdAcoBody.prototype.adgroup_id = undefined;
 ...
 */
AdAcoBody.prototype.title_list = undefined;
