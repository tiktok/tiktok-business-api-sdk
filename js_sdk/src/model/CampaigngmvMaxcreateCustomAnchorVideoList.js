...
import {CampaigngmvMaxcreateCustomAnchorVideoListIdentityInfo} from './CampaigngmvMaxcreateCustomAnchorVideoListIdentityInfo.js';
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('identity_info'))
        obj.identity_info = CampaigngmvMaxcreateCustomAnchorVideoListIdentityInfo.constructFromObject(data['identity_info']);
...
/**
 * @member {module:model/CampaigngmvMaxcreateCustomAnchorVideoListIdentityInfo} identity_info
 */
