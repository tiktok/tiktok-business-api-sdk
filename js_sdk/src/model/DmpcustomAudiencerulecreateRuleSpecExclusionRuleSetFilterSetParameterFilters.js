...
export class DmpcustomAudiencerulecreateRuleSpecExclusionRuleSetFilterSetParameterFilters {
   ...
   * @alias module:model/DmpcustomAudiencerulecreateRuleSpecExclusionRuleSetFilterSetParameterFilters
   * @class
  ...
  /**
   * Constructs a <code>DmpcustomAudiencerulecreateRuleSpecExclusionRuleSetFilterSetParameterFilters</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DmpcustomAudiencerulecreateRuleSpecExclusionRuleSetFilterSetParameterFilters} obj Optional instance to populate.
   * @return {module:model/DmpcustomAudiencerulecreateRuleSpecExclusionRuleSetFilterSetParameterFilters} The populated <code>DmpcustomAudiencerulecreateRuleSpecExclusionRuleSetFilterSetParameterFilters</code> instance.
   */
 ...
 * @member {String} field
 */
DmpcustomAudiencerulecreateRuleSpecExclusionRuleSetFilterSetParameterFilters.prototype.field = undefined;

/**
 * Required when parameter_filters within exclusion_rule_set is passed. Filter operator between filter condition and filter value. Enum value: CONTAINS: contains. DOES_NOT_CONTAIN: doesn't contain. EQ: equals. IS_LESS_THAN: is less than. IS_GREATER_THAN: is greater than. IS_LESS_THAN_OR_EQUAL_TO: is less than or equal to. IS_GRETER_THAN_OR_EQUAL_TO: is greater than or equal to. The allowed values vary based on the field value: If field is set to URL, operator can only be set to CONTAINS, DOES_NOT_CONTAIN, or EQ. If field is not set to URL, operator can be set to CONTAINS, DOES_NOT_CONTAINS, EQ, IS_LESS_THAN, IS_GREATER_THAN, IS_LESS_THAN_OR_EQUAL_TO, or IS_GREATER_THAN_OR_EQUAL_TO.
 * @member {String} operator
 */
DmpcustomAudiencerulecreateRuleSpecExclusionRuleSetFilterSetParameterFilters.prototype.operator = undefined;
 ...
 */
DmpcustomAudiencerulecreateRuleSpecExclusionRuleSetFilterSetParameterFilters.prototype.values = undefined;
