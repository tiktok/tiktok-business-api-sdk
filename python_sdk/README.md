...
*AdApi* | [**ad_create**](docs/AdApi.md#ad_create) | **POST** /ad/create/ | Create ad. [Ad Create](https://business-api.tiktok.com/portal/docs?id=1739953377508354)
*AdApi* | [**ad_get**](docs/AdApi.md#ad_get) | **GET** /ad/get/ | Get ads. [Ad Get](https://business-api.tiktok.com/portal/docs?id=1735735588640770)
*AdApi* | [**ad_status_update**](docs/AdApi.md#ad_status_update) | **POST** /ad/status/update/ | Update ad status. [Ad Status Update](https://business-api.tiktok.com/portal/docs?id=1739953422970882)
*AdApi* | [**ad_update**](docs/AdApi.md#ad_update) | **POST** /ad/update/ | Update ad. [Ad Update](https://business-api.tiktok.com/portal/docs?id=1739953405142018)
...
*AdgroupApi* | [**adgroup_create**](docs/AdgroupApi.md#adgroup_create) | **POST** /adgroup/create/ | Create adgroup. [Adgroup Create](https://business-api.tiktok.com/portal/docs?id=1739499616346114)
*AdgroupApi* | [**adgroup_get**](docs/AdgroupApi.md#adgroup_get) | **GET** /adgroup/get/ | Get adgroups. [Adgroup Get](https://business-api.tiktok.com/portal/docs?id=1739314558673922)
...
*AdgroupApi* | [**adgroup_status_update**](docs/AdgroupApi.md#adgroup_status_update) | **POST** /adgroup/status/update/ | Update adgroup status. [Adgroup Status Update](https://business-api.tiktok.com/portal/docs?id=1739591716326402)
*AdgroupApi* | [**adgroup_update**](docs/AdgroupApi.md#adgroup_update) | **POST** /adgroup/update/ | Update adgroup. [Adgroup Update](https://business-api.tiktok.com/portal/docs?id=1739586761631745)
...
*CampaignCreationApi* | [**campaign_create**](docs/CampaignCreationApi.md#campaign_create) | **POST** /campaign/create/ | Create campaign. [Campaign Create](https://business-api.tiktok.com/portal/docs?id=1739318962329602)
*CampaignCreationApi* | [**campaign_get**](docs/CampaignCreationApi.md#campaign_get) | **GET** /campaign/get/ | Get campaigns. [Campaign Get](https://business-api.tiktok.com/portal/docs?id=1739315828649986)
*CampaignCreationApi* | [**campaign_gmv_max_create**](docs/CampaignCreationApi.md#campaign_gmv_max_create) | **POST** /campaign/gmv_max/create/ | Create GMV Max campaign [Smart Plus GMV Max Campaign Create](https://business-api.tiktok.com/portal/docs?id=1822000988713089)
*CampaignCreationApi* | [**campaign_gmv_max_info**](docs/CampaignCreationApi.md#campaign_gmv_max_info) | **GET** /campaign/gmv_max/info/ | Get GMV Max campaign info [Smart Plus GMV Max Campaign Info](https://business-api.tiktok.com/portal/docs?id=1822000968821762)
*CampaignCreationApi* | [**campaign_gmv_max_session_create**](docs/CampaignCreationApi.md#campaign_gmv_max_session_create) | **POST** /campaign/gmv_max/session/create/ | Create GMV Max session [Smart Plus GMV Max Session Create](https://business-api.tiktok.com/portal/docs?id=1835246967275522)
*CampaignCreationApi* | [**campaign_gmv_max_session_delete**](docs/CampaignCreationApi.md#campaign_gmv_max_session_delete) | **POST** /campaign/gmv_max/session/delete/ | Delete GMV Max session [Smart Plus GMV Max Session Delete](https://business-api.tiktok.com/portal/docs?id=1835246983475217)
*CampaignCreationApi* | [**campaign_gmv_max_session_get**](docs/CampaignCreationApi.md#campaign_gmv_max_session_get) | **GET** /campaign/gmv_max/session/get/ | Get GMV Max session info [Smart Plus GMV Max Session Get](https://business-api.tiktok.com/portal/docs?id=1835247031331842)
*CampaignCreationApi* | [**campaign_gmv_max_session_list**](docs/CampaignCreationApi.md#campaign_gmv_max_session_list) | **GET** /campaign/gmv_max/session/list/ | Get GMV Max session list [Smart Plus GMV Max Session List](https://business-api.tiktok.com/portal/docs?id=1835246996436162)
*CampaignCreationApi* | [**campaign_gmv_max_session_update**](docs/CampaignCreationApi.md#campaign_gmv_max_session_update) | **POST** /campaign/gmv_max/session/update/ | Update GMV Max session [Smart Plus GMV Max Session Update](https://business-api.tiktok.com/portal/docs?id=1835247009119233)
*CampaignCreationApi* | [**campaign_gmv_max_update**](docs/CampaignCreationApi.md#campaign_gmv_max_update) | **POST** /campaign/gmv_max/update/ | Update GMV Max campaign [Smart Plus GMV Max Campaign Update](https://business-api.tiktok.com/portal/docs?id=1822001009002497)
*CampaignCreationApi* | [**campaign_status_update**](docs/CampaignCreationApi.md#campaign_status_update) | **POST** /campaign/status/update/ | Update campaign status. [Campaign Status Update](https://business-api.tiktok.com/portal/docs?id=1739320994354178)
*CampaignCreationApi* | [**campaign_update**](docs/CampaignCreationApi.md#campaign_update) | **POST** /campaign/update/ | Update campaign. [Campaign Update](https://business-api.tiktok.com/portal/docs?id=1739320422086657)
*CampaignCreationApi* | [**gmv_max_bid_recommend**](docs/CampaignCreationApi.md#gmv_max_bid_recommend) | **GET** /gmv_max/bid/recommend/ | Get GMV Max bid recommendation [Smart Plus GMV Max Bid Recommend](https://business-api.tiktok.com/portal/docs?id=1822001024720897)
*CampaignCreationApi* | [**gmv_max_custom_anchor_video_list_get**](docs/CampaignCreationApi.md#gmv_max_custom_anchor_video_list_get) | **GET** /gmv_max/custom_anchor_video_list/get/ | Get GMV Max custom anchor video list [Smart Plus GMV Max Custom Anchor Video List Get](https://business-api.tiktok.com/portal/docs?id=1830215925061633)
*CampaignCreationApi* | [**gmv_max_occupied_custom_shop_ads_list**](docs/CampaignCreationApi.md#gmv_max_occupied_custom_shop_ads_list) | **GET** /gmv_max/occupied_custom_shop_ads/list/ | Get GMV Max occupied custom shop ads [Smart Plus GMV Max Occupied Custom Shop Ads List](https://business-api.tiktok.com/portal/docs?id=1822001136924674)
...
*IdentityApi* | [**gmv_max_identity_get**](docs/IdentityApi.md#gmv_max_identity_get) | **GET** /gmv_max/identity/get/ | Get GMV Max identity info [Smart Plus GMV Max Identity Get](https://business-api.tiktok.com/portal/docs?id=1822001101474882)
...
*ReportingApi* | [**gmv_max_report_get**](docs/ReportingApi.md#gmv_max_report_get) | **GET** /gmv_max/report/get/ | Get GMV Max report [Smart Plus GMV Max Report Get](https://business-api.tiktok.com/portal/docs?id=1824721673497601)
...
*StoreApi* | [**gmv_max_exclusive_authorization_create**](docs/StoreApi.md#gmv_max_exclusive_authorization_create) | **POST** /gmv_max/exclusive_authorization/create/ | Create GMV Max exclusive authorization [Smart Plus GMV Max Exclusive Authorization Create](https://business-api.tiktok.com/portal/docs?id=1822001200356354)
*StoreApi* | [**gmv_max_exclusive_authorization_get**](docs/StoreApi.md#gmv_max_exclusive_authorization_get) | **GET** /gmv_max/exclusive_authorization/get/ | Get GMV Max exclusive authorization [Smart Plus GMV Max Exclusive Authorization Get](https://business-api.tiktok.com/portal/docs?id=1822001184635905)
*StoreApi* | [**gmv_max_store_list**](docs/StoreApi.md#gmv_max_store_list) | **GET** /gmv_max/store/list/ | Get GMV Max store list [Smart Plus GMV Max Store List](https://business-api.tiktok.com/portal/docs?id=1822001044479041)
*StoreApi* | [**gmv_max_store_shop_ad_usage_check**](docs/StoreApi.md#gmv_max_store_shop_ad_usage_check) | **GET** /gmv_max/store/shop_ad_usage_check/ | Check GMV Max shop ad usage [Smart Plus GMV Max Shop Ad Usage Check](https://business-api.tiktok.com/portal/docs?id=1822001084174338)
...
*ToolApi* | [**tool_diagnosis_search_health**](docs/ToolApi.md#tool_diagnosis_search_health) | **GET** /tool/diagnosis/search/health/ | Get Search Ads Campaign Health diagnoses [Tool Diagnosis Search Health](https://business-api.tiktok.com/portal/docs?id=1848591212970082)
...
*VideoApi* | [**gmv_max_video_get**](docs/VideoApi.md#gmv_max_video_get) | **GET** /gmv_max/video/get/ | Get GMV Max video info [Smart Plus GMV Max Video Get](https://business-api.tiktok.com/portal/docs?id=1822001168512129)
...
## Documentation For Models
 ...
 - [AdcreateDeeplinkUtmParams](docs/AdcreateDeeplinkUtmParams.md)
 ...
 - [AdcreateShowcaseProducts](docs/AdcreateShowcaseProducts.md)
 - [AdcreateUtmParams](docs/AdcreateUtmParams.md)
 ...
 - [AdgroupcreateAppConfig](docs/AdgroupcreateAppConfig.md)
 ...
 - [AdgroupcreateSearchKeywords](docs/AdgroupcreateSearchKeywords.md)
 - [AdgroupupdateSearchKeywords](docs/AdgroupupdateSearchKeywords.md)
 - [AdgroupupdateTargetingExpansion](docs/AdgroupupdateTargetingExpansion.md)
 ...
 - [CampaigngmvMaxcreateCustomAnchorVideoList](docs/CampaigngmvMaxcreateCustomAnchorVideoList.md)
 - [CampaigngmvMaxcreateCustomAnchorVideoListIdentityInfo](docs/CampaigngmvMaxcreateCustomAnchorVideoListIdentityInfo.md)
 - [CampaigngmvMaxcreateIdentityList](docs/CampaigngmvMaxcreateIdentityList.md)
 - [CampaigngmvMaxcreateItemList](docs/CampaigngmvMaxcreateItemList.md)
 - [CampaigngmvMaxcreateItemListIdentityInfo](docs/CampaigngmvMaxcreateItemListIdentityInfo.md)
 - [CampaigngmvMaxcreatePromotionDays](docs/CampaigngmvMaxcreatePromotionDays.md)
 - [CampaigngmvMaxcreatePromotionDaysCustomScheduleList](docs/CampaigngmvMaxcreatePromotionDaysCustomScheduleList.md)
 - [CampaigngmvMaxcreateVideoInfo](docs/CampaigngmvMaxcreateVideoInfo.md)
 - [CampaigngmvMaxsessioncreateSession](docs/CampaigngmvMaxsessioncreateSession.md)
 - [CampaigngmvMaxsessioncreateSessionProductList](docs/CampaigngmvMaxsessioncreateSessionProductList.md)
 - [CampaigngmvMaxsessionupdateSession](docs/CampaigngmvMaxsessionupdateSession.md)
 - [CampaigngmvMaxupdateCustomAnchorVideoList](docs/CampaigngmvMaxupdateCustomAnchorVideoList.md)
 - [CampaigngmvMaxupdateCustomAnchorVideoListIdentityInfo](docs/CampaigngmvMaxupdateCustomAnchorVideoListIdentityInfo.md)
 - [CampaigngmvMaxupdateItemList](docs/CampaigngmvMaxupdateItemList.md)
 - [CampaigngmvMaxupdateItemListIdentityInfo](docs/CampaigngmvMaxupdateItemListIdentityInfo.md)
 - [CampaigngmvMaxupdatePromotionDays](docs/CampaigngmvMaxupdatePromotionDays.md)
 - [CampaigngmvMaxupdatePromotionDaysCustomScheduleList](docs/CampaigngmvMaxupdatePromotionDaysCustomScheduleList.md)
 - [CampaigngmvMaxupdateVideoInfo](docs/CampaigngmvMaxupdateVideoInfo.md)
 ...
 - [ContextInfoGmvMaxReportGet](docs/ContextInfoGmvMaxReportGet.md)
 ...
 - [CustomAnchorVideoList](docs/CustomAnchorVideoList.md)
 ...
 - [ExclusiveAuthorizationCreateBody](docs/ExclusiveAuthorizationCreateBody.md)
 ...
 - [FilteringGmvMaxReportGet](docs/FilteringGmvMaxReportGet.md)
 ...
 - [GmvMaxCreateBody](docs/GmvMaxCreateBody.md)
 - [GmvMaxUpdateBody](docs/GmvMaxUpdateBody.md)
 - [GmvMaxcustomAnchorVideoListgetIdentityInfo](docs/GmvMaxcustomAnchorVideoListgetIdentityInfo.md)
 ...
 - [SessionCreateBody](docs/SessionCreateBody.md)
 - [SessionDeleteBody](docs/SessionDeleteBody.md)
 - [SessionUpdateBody](docs/SessionUpdateBody.md)
