...
class OpenApiv13dmpcustomAudiencerulecreateRuleSpecInclusionRuleSetRules(object):
    ...
    swagger_types = {
        ...
        'filter_set': 'OpenApiv13dmpcustomAudiencerulecreateRuleSpecInclusionRuleSetFilterSet',
        'retention_days': 'int'
    }
    ...
    def __init__(self, event_source_ids=None, filter_set=None, retention_days=None):  # noqa: E501
        """OpenApiv13dmpcustomAudiencerulecreateRuleSpecInclusionRuleSetRules - a model defined in Swagger"""  # noqa: E501
    ...
    def event_source_ids(self):
        """Gets the event_source_ids of this OpenApiv13dmpcustomAudiencerulecreateRuleSpecInclusionRuleSetRules.  # noqa: E501
        ...
        :return: The event_source_ids of this OpenApiv13dmpcustomAudiencerulecreateRuleSpecInclusionRuleSetRules.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def event_source_ids(self, event_source_ids):
        """Sets the event_source_ids of this OpenApiv13dmpcustomAudiencerulecreateRuleSpecInclusionRuleSetRules.

        Required when audience_type is not ENGAGEMENT or LEAD_GENERATION. List of event source IDs of the rule. For an Engagement Audience, use ad group IDs as event source IDs. If not specified, all available event source IDs will be used. For an Organic Engagement Audience, use TikTok post IDs as event source IDs. You can use /identity/video/get/ to get TikTok post IDs. The maximum allowed number of TikTok post IDs is 10. For a Live Engagement Audience, use live video ID as event source IDs. You can use /identity/live/get/ to get live video IDs. The maximum allowed number of live video IDs is 10. For an App Activity Audience, use App IDs as event source IDs. For a Website Traffic Audience, use pixel IDs as event source IDs. For a Lead Generation Audience, do not pass in this field. Otherwise, an error will occur. If not specified, all available event source IDs will be used. For a Business Account Audience, use core user IDs of the advertisers. You can use /user/info/ to get a core user ID. For a Shop Activity Audience, use TikTok Shop IDs as event source IDs. You can use /store/list/ to get TikTok Shop IDs. For an Offline Activity Audience, use Offline Event set IDs as event source IDs. You can use /offline/get/ to get Offline Event set IDs.  # noqa: E501

        :param event_source_ids: The event_source_ids of this OpenApiv13dmpcustomAudiencerulecreateRuleSpecInclusionRuleSetRules.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def filter_set(self):
        """Gets the filter_set of this OpenApiv13dmpcustomAudiencerulecreateRuleSpecInclusionRuleSetRules.  # noqa: E501


        :return: The filter_set of this OpenApiv13dmpcustomAudiencerulecreateRuleSpecInclusionRuleSetRules.  # noqa: E501
        :rtype: OpenApiv13dmpcustomAudiencerulecreateRuleSpecInclusionRuleSetFilterSet
        """
        return self._filter_set

    @filter_set.setter
    def filter_set(self, filter_set):
        """Sets the filter_set of this OpenApiv13dmpcustomAudiencerulecreateRuleSpecInclusionRuleSetRules.


        :param filter_set: The filter_set of this OpenApiv13dmpcustomAudiencerulecreateRuleSpecInclusionRuleSetRules.  # noqa: E501
        :type: OpenApiv13dmpcustomAudiencerulecreateRuleSpecInclusionRuleSetFilterSet
        """
    ...
    def retention_days(self):
        """Gets the retention_days of this OpenApiv13dmpcustomAudiencerulecreateRuleSpecInclusionRuleSetRules.  # noqa: E501
        ...
        :return: The retention_days of this OpenApiv13dmpcustomAudiencerulecreateRuleSpecInclusionRuleSetRules.  # noqa: E501
        :rtype: int
        """
    ...
    def retention_days(self, retention_days):
        """Sets the retention_days of this OpenApiv13dmpcustomAudiencerulecreateRuleSpecInclusionRuleSetRules.

        Audience lookback window. For enum values, see Enumerations - Lookback window. Note: If audience_type = BUSINESS_ACCOUNT, and the value in the filters object is not BUSINESS ACCOUNT PROFILE FOLLOW, then retention_days must be 7, 14, or 30. If audience_type = ENGAGEMENT_LIVE_VIDEO or ENGAGEMENT_ORGANIC_VIDEO, then retention_days must be 7, 14, or 30. To avoid confusion between retention_days and retention_in_days, we'll rename retention_days in the next API version.  # noqa: E501

        :param retention_days: The retention_days of this OpenApiv13dmpcustomAudiencerulecreateRuleSpecInclusionRuleSetRules.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OpenApiv13dmpcustomAudiencerulecreateRuleSpecInclusionRuleSetRules, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OpenApiv13dmpcustomAudiencerulecreateRuleSpecInclusionRuleSetRules):
            return False
