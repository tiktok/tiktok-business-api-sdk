...
class CreativeportfoliocreateBadgeImageInfo(object):
    ...
    def __init__(self, image_id=None):  # noqa: E501
        """CreativeportfoliocreateBadgeImageInfo - a model defined in Swagger"""  # noqa: E501
        self._image_id = None
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CreativeportfoliocreateBadgeImageInfo, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreativeportfoliocreateBadgeImageInfo):
            return False
