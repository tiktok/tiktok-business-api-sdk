...
class AdgroupcreateActions(object):
    ...
    def __init__(self, action_category_ids=None, action_period=None, action_scene=None, video_user_actions=None):  # noqa: E501
        """AdgroupcreateActions - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AdgroupcreateActions, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AdgroupcreateActions):
            return False
