...
class ToolApi(object):
    ...
    def tool_diagnosis_search_health(self, advertiser_id, access_token, **kwargs):  # noqa: E501
        """Get Search Ads Campaign Health diagnoses [Tool Diagnosis Search Health](https://business-api.tiktok.com/portal/docs?id=1848591212970082)  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.tool_diagnosis_search_health(advertiser_id, access_token, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str advertiser_id: (required)
        :param str access_token: Authorized access token. For details, see [Authentication](https://ads.tiktok.com/marketing_api/docs?id=1738373164380162). (required)
        :param str adgroup_id:
        :param list[str] ad_ids:
        :return: InlineResponse200
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.tool_diagnosis_search_health_with_http_info(advertiser_id, access_token, **kwargs)  # noqa: E501
        else:
            (data) = self.tool_diagnosis_search_health_with_http_info(advertiser_id, access_token, **kwargs)  # noqa: E501
            return data

    def tool_diagnosis_search_health_with_http_info(self, advertiser_id, access_token, **kwargs):  # noqa: E501
        """Get Search Ads Campaign Health diagnoses [Tool Diagnosis Search Health](https://business-api.tiktok.com/portal/docs?id=1848591212970082)  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.tool_diagnosis_search_health_with_http_info(advertiser_id, access_token, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['advertiser_id', 'access_token', 'adgroup_id', 'ad_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method tool_diagnosis_search_health" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'advertiser_id' is set
        if ('advertiser_id' not in params or
                params['advertiser_id'] is None):
            raise ValueError("Missing the required parameter `advertiser_id` when calling `tool_diagnosis_search_health`")  # noqa: E501
        # verify the required parameter 'access_token' is set
        if ('access_token' not in params or
                params['access_token'] is None):
            raise ValueError("Missing the required parameter `access_token` when calling `tool_diagnosis_search_health`")  # noqa: E501
        ...
        if 'advertiser_id' in params:
            query_params.append(('advertiser_id', params['advertiser_id']))  # noqa: E501
        if 'adgroup_id' in params:
            query_params.append(('adgroup_id', params['adgroup_id']))  # noqa: E501
        if 'ad_ids' in params:
            query_params.append(('ad_ids', params['ad_ids']))  # noqa: E501
            collection_formats['ad_ids'] = 'multi'  # noqa: E501
