...
import business_api_client.OpenApiv13dmpcustomAudiencerulecreateRuleSpecInclusionRuleSetFilterSet;
...
public class OpenApiv13dmpcustomAudiencerulecreateRuleSpecInclusionRuleSetRules {
  @JsonProperty("event_source_ids")
  private List<String> eventSourceIds = null;

  @JsonProperty("filter_set")
  private OpenApiv13dmpcustomAudiencerulecreateRuleSpecInclusionRuleSetFilterSet filterSet = null;

  @JsonProperty("retention_days")
  private Integer retentionDays = null;

  public OpenApiv13dmpcustomAudiencerulecreateRuleSpecInclusionRuleSetRules eventSourceIds(List<String> eventSourceIds) {
    this.eventSourceIds = eventSourceIds;
    return this;
  }

  public OpenApiv13dmpcustomAudiencerulecreateRuleSpecInclusionRuleSetRules addEventSourceIdsItem(String eventSourceIdsItem) {
  ...
  **/
  ...
  public OpenApiv13dmpcustomAudiencerulecreateRuleSpecInclusionRuleSetRules filterSet(OpenApiv13dmpcustomAudiencerulecreateRuleSpecInclusionRuleSetFilterSet filterSet) {
  ...
  **/
  @Schema(description = "")
  public OpenApiv13dmpcustomAudiencerulecreateRuleSpecInclusionRuleSetFilterSet getFilterSet() {
    return filterSet;
  }

  public void setFilterSet(OpenApiv13dmpcustomAudiencerulecreateRuleSpecInclusionRuleSetFilterSet filterSet) {
    this.filterSet = filterSet;
  }

  public OpenApiv13dmpcustomAudiencerulecreateRuleSpecInclusionRuleSetRules retentionDays(Integer retentionDays) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    OpenApiv13dmpcustomAudiencerulecreateRuleSpecInclusionRuleSetRules openApiv13dmpcustomAudiencerulecreateRuleSpecInclusionRuleSetRules = (OpenApiv13dmpcustomAudiencerulecreateRuleSpecInclusionRuleSetRules) o;
    return Objects.equals(this.eventSourceIds, openApiv13dmpcustomAudiencerulecreateRuleSpecInclusionRuleSetRules.eventSourceIds) &&
        Objects.equals(this.filterSet, openApiv13dmpcustomAudiencerulecreateRuleSpecInclusionRuleSetRules.filterSet) &&
        Objects.equals(this.retentionDays, openApiv13dmpcustomAudiencerulecreateRuleSpecInclusionRuleSetRules.retentionDays);
  }
  ...
  public String toString() {
    ...
    sb.append("class OpenApiv13dmpcustomAudiencerulecreateRuleSpecInclusionRuleSetRules {\n");
