...
import business_api_client.DmpcustomAudiencerulecreateRuleSpecExclusionRuleSetFilterSet;
...
public class DmpcustomAudiencerulecreateRuleSpecExclusionRuleSetRules {
  @JsonProperty("event_source_ids")
  private List<String> eventSourceIds = null;

  @JsonProperty("filter_set")
  private DmpcustomAudiencerulecreateRuleSpecExclusionRuleSetFilterSet filterSet = null;

  @JsonProperty("retention_days")
  private Integer retentionDays = null;

  public DmpcustomAudiencerulecreateRuleSpecExclusionRuleSetRules eventSourceIds(List<String> eventSourceIds) {
    this.eventSourceIds = eventSourceIds;
    return this;
  }

  public DmpcustomAudiencerulecreateRuleSpecExclusionRuleSetRules addEventSourceIdsItem(String eventSourceIdsItem) {
  ...
  **/
  ...
  public DmpcustomAudiencerulecreateRuleSpecExclusionRuleSetRules filterSet(DmpcustomAudiencerulecreateRuleSpecExclusionRuleSetFilterSet filterSet) {
  ...
  **/
  @Schema(description = "")
  public DmpcustomAudiencerulecreateRuleSpecExclusionRuleSetFilterSet getFilterSet() {
    return filterSet;
  }

  public void setFilterSet(DmpcustomAudiencerulecreateRuleSpecExclusionRuleSetFilterSet filterSet) {
    this.filterSet = filterSet;
  }

  public DmpcustomAudiencerulecreateRuleSpecExclusionRuleSetRules retentionDays(Integer retentionDays) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DmpcustomAudiencerulecreateRuleSpecExclusionRuleSetRules dmpcustomAudiencerulecreateRuleSpecExclusionRuleSetRules = (DmpcustomAudiencerulecreateRuleSpecExclusionRuleSetRules) o;
    return Objects.equals(this.eventSourceIds, dmpcustomAudiencerulecreateRuleSpecExclusionRuleSetRules.eventSourceIds) &&
        Objects.equals(this.filterSet, dmpcustomAudiencerulecreateRuleSpecExclusionRuleSetRules.filterSet) &&
        Objects.equals(this.retentionDays, dmpcustomAudiencerulecreateRuleSpecExclusionRuleSetRules.retentionDays);
  }
  ...
  public String toString() {
    ...
    sb.append("class DmpcustomAudiencerulecreateRuleSpecExclusionRuleSetRules {\n");
