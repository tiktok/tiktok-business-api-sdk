...
import business_api_client.CampaigngmvMaxcreateIdentityInfo1;
...
public class CampaigngmvMaxcreateItemList {
  ...
  private CampaigngmvMaxcreateIdentityInfo1 identityInfo = null;
  ...
  public CampaigngmvMaxcreateItemList identityInfo(CampaigngmvMaxcreateIdentityInfo1 identityInfo) {
  ...
  **/
  @Schema(description = "")
  public CampaigngmvMaxcreateIdentityInfo1 getIdentityInfo() {
    return identityInfo;
  }

  public void setIdentityInfo(CampaigngmvMaxcreateIdentityInfo1 identityInfo) {
    this.identityInfo = identityInfo;
  }
