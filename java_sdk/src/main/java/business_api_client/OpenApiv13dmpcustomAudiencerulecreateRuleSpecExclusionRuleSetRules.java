...
import business_api_client.OpenApiv13dmpcustomAudiencerulecreateRuleSpecExclusionRuleSetFilterSet;
...
public class OpenApiv13dmpcustomAudiencerulecreateRuleSpecExclusionRuleSetRules {
  @JsonProperty("event_source_ids")
  private List<String> eventSourceIds = null;

  @JsonProperty("filter_set")
  private OpenApiv13dmpcustomAudiencerulecreateRuleSpecExclusionRuleSetFilterSet filterSet = null;

  @JsonProperty("retention_days")
  private Integer retentionDays = null;

  public OpenApiv13dmpcustomAudiencerulecreateRuleSpecExclusionRuleSetRules eventSourceIds(List<String> eventSourceIds) {
    this.eventSourceIds = eventSourceIds;
    return this;
  }

  public OpenApiv13dmpcustomAudiencerulecreateRuleSpecExclusionRuleSetRules addEventSourceIdsItem(String eventSourceIdsItem) {
  ...
  **/
  ...
  public OpenApiv13dmpcustomAudiencerulecreateRuleSpecExclusionRuleSetRules filterSet(OpenApiv13dmpcustomAudiencerulecreateRuleSpecExclusionRuleSetFilterSet filterSet) {
  ...
  **/
  @Schema(description = "")
  public OpenApiv13dmpcustomAudiencerulecreateRuleSpecExclusionRuleSetFilterSet getFilterSet() {
    return filterSet;
  }

  public void setFilterSet(OpenApiv13dmpcustomAudiencerulecreateRuleSpecExclusionRuleSetFilterSet filterSet) {
    this.filterSet = filterSet;
  }

  public OpenApiv13dmpcustomAudiencerulecreateRuleSpecExclusionRuleSetRules retentionDays(Integer retentionDays) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    OpenApiv13dmpcustomAudiencerulecreateRuleSpecExclusionRuleSetRules openApiv13dmpcustomAudiencerulecreateRuleSpecExclusionRuleSetRules = (OpenApiv13dmpcustomAudiencerulecreateRuleSpecExclusionRuleSetRules) o;
    return Objects.equals(this.eventSourceIds, openApiv13dmpcustomAudiencerulecreateRuleSpecExclusionRuleSetRules.eventSourceIds) &&
        Objects.equals(this.filterSet, openApiv13dmpcustomAudiencerulecreateRuleSpecExclusionRuleSetRules.filterSet) &&
        Objects.equals(this.retentionDays, openApiv13dmpcustomAudiencerulecreateRuleSpecExclusionRuleSetRules.retentionDays);
  }
  ...
  public String toString() {
    ...
    sb.append("class OpenApiv13dmpcustomAudiencerulecreateRuleSpecExclusionRuleSetRules {\n");
