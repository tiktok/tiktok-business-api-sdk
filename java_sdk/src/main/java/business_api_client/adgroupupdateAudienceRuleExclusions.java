...
public class adgroupupdateAudienceRuleExclusions {
  ...
  public adgroupupdateAudienceRuleExclusions operator(String operator) {
  ...
  **/
  ...
  public adgroupupdateAudienceRuleExclusions rules(List<adgroupcreateAudienceRuleInclusionsRules> rules) {
    this.rules = rules;
    return this;
  }

  public adgroupupdateAudienceRuleExclusions addRulesItem(adgroupcreateAudienceRuleInclusionsRules rulesItem) {
    if (this.rules == null) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    adgroupupdateAudienceRuleExclusions adgroupupdateAudienceRuleExclusions = (adgroupupdateAudienceRuleExclusions) o;
    return Objects.equals(this.operator, adgroupupdateAudienceRuleExclusions.operator) &&
        Objects.equals(this.rules, adgroupupdateAudienceRuleExclusions.rules);
  }
  ...
  public String toString() {
    ...
    sb.append("class adgroupupdateAudienceRuleExclusions {\n");
