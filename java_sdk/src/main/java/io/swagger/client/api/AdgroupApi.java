...
import business_api_client.FilteringSmartPlusAdgroupGet;
import business_api_client.InlineResponse200;
import business_api_client.SmartPlusAdgroupCreateBody;
import business_api_client.SmartPlusAdgroupStatusUpdateBody;
import business_api_client.SmartPlusAdgroupUpdateBody;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2025-10-02T15:20:10.801947-07:00[America/Los_Angeles]")public class AdgroupApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public Response adgroupQuota(String advertiserId, String accessToken) throws ApiException, SDKException, SDKExceptionForEvent {
    Object localVarPostBody = null;
    // verify the required parameter 'advertiserId' is set
    if (advertiserId == null) {
      throw new ApiException(400, "Missing the required parameter 'advertiserId' when calling adgroupQuota");
    }
    // verify the required parameter 'accessToken' is set
    if (accessToken == null) {
      throw new ApiException(400, "Missing the required parameter 'accessToken' when calling adgroupQuota");
    }
    // create path and map variables
    String localVarPath = "/open_api/v1.3/adgroup/quota/";
   ...
   * @throws ApiException if fails to make API call
   */
  public Response smartPlusAdgroupCreate(String accessToken, SmartPlusAdgroupCreateBody body) throws ApiException, SDKException, SDKExceptionForEvent {
    Object localVarPostBody = body;
    // verify the required parameter 'accessToken' is set
    if (accessToken == null) {
      throw new ApiException(400, "Missing the required parameter 'accessToken' when calling smartPlusAdgroupCreate");
    }
    // create path and map variables
    String localVarPath = "/open_api/v1.3/smart_plus/adgroup/create/";
   ...
   * @throws ApiException if fails to make API call
   */
  public Response smartPlusAdgroupGet(String advertiserId, String accessToken, FilteringSmartPlusAdgroupGet filtering, Long page, Long pageSize, List<String> fields) throws ApiException, SDKException, SDKExceptionForEvent {
    Object localVarPostBody = null;
    // verify the required parameter 'advertiserId' is set
    if (advertiserId == null) {
      throw new ApiException(400, "Missing the required parameter 'advertiserId' when calling smartPlusAdgroupGet");
    }
    // verify the required parameter 'accessToken' is set
    if (accessToken == null) {
      throw new ApiException(400, "Missing the required parameter 'accessToken' when calling smartPlusAdgroupGet");
    }
    // create path and map variables
    String localVarPath = "/open_api/v1.3/smart_plus/adgroup/get/";
   ...
   * @throws ApiException if fails to make API call
   */
  public Response smartPlusAdgroupStatusUpdate(String accessToken, SmartPlusAdgroupStatusUpdateBody body) throws ApiException, SDKException, SDKExceptionForEvent {
    Object localVarPostBody = body;
    // verify the required parameter 'accessToken' is set
    if (accessToken == null) {
      throw new ApiException(400, "Missing the required parameter 'accessToken' when calling smartPlusAdgroupStatusUpdate");
    }
    // create path and map variables
    String localVarPath = "/open_api/v1.3/smart_plus/adgroup/status/update/";
   ...
   * @throws ApiException if fails to make API call
   */
  public Response smartPlusAdgroupUpdate(String accessToken, SmartPlusAdgroupUpdateBody body) throws ApiException, SDKException, SDKExceptionForEvent {
    Object localVarPostBody = body;
    // verify the required parameter 'accessToken' is set
    if (accessToken == null) {
      throw new ApiException(400, "Missing the required parameter 'accessToken' when calling smartPlusAdgroupUpdate");
    }
    // create path and map variables
    String localVarPath = "/open_api/v1.3/smart_plus/adgroup/update/";
