...
import business_api_client.ContextInfoCatalogFeedLog;
import business_api_client.ContextInfoCatalogProductLog;
import business_api_client.EventsourceBindBody;
import business_api_client.EventsourceUnbindBody;
import business_api_client.FeedCreateBody;
import business_api_client.FeedDeleteBody;
import business_api_client.FeedUpdateBody;
...
import business_api_client.SetDeleteBody;
import business_api_client.SetUpdateBody;
import business_api_client.VideoDeleteBody;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2025-10-02T15:20:10.801947-07:00[America/Los_Angeles]")public class CatalogApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public Response catalogFeedCreate(String accessToken, FeedCreateBody body) throws ApiException, SDKException, SDKExceptionForEvent {
    Object localVarPostBody = body;
    // verify the required parameter 'accessToken' is set
    if (accessToken == null) {
      throw new ApiException(400, "Missing the required parameter 'accessToken' when calling catalogFeedCreate");
    }
    // create path and map variables
    String localVarPath = "/open_api/v1.3/catalog/feed/create/";
   ...
   * @throws ApiException if fails to make API call
   */
  public Response catalogFeedLog(String bcId, String catalogId, String feedId, String accessToken, ContextInfoCatalogFeedLog contextInfo) throws ApiException, SDKException, SDKExceptionForEvent {
    Object localVarPostBody = null;
    // verify the required parameter 'bcId' is set
    if (bcId == null) {
      throw new ApiException(400, "Missing the required parameter 'bcId' when calling catalogFeedLog");
    }
    // verify the required parameter 'catalogId' is set
    if (catalogId == null) {
      throw new ApiException(400, "Missing the required parameter 'catalogId' when calling catalogFeedLog");
    }
    // verify the required parameter 'feedId' is set
    if (feedId == null) {
      throw new ApiException(400, "Missing the required parameter 'feedId' when calling catalogFeedLog");
    }
    // verify the required parameter 'accessToken' is set
    if (accessToken == null) {
      throw new ApiException(400, "Missing the required parameter 'accessToken' when calling catalogFeedLog");
    }
    // create path and map variables
    String localVarPath = "/open_api/v1.3/catalog/feed/log/";
   ...
   * @throws ApiException if fails to make API call
   */
  public Response catalogFeedUpdate(String accessToken, FeedUpdateBody body) throws ApiException, SDKException, SDKExceptionForEvent {
    Object localVarPostBody = body;
    // verify the required parameter 'accessToken' is set
    if (accessToken == null) {
      throw new ApiException(400, "Missing the required parameter 'accessToken' when calling catalogFeedUpdate");
    }
    // create path and map variables
    String localVarPath = "/open_api/v1.3/catalog/feed/update/";
   ...
   * @throws ApiException if fails to make API call
   */
  public Response catalogProductLog(String bcId, String catalogId, String feedLogId, String accessToken, String advertiserId, String language, ContextInfoCatalogProductLog contextInfo) throws ApiException, SDKException, SDKExceptionForEvent {
    Object localVarPostBody = null;
    // verify the required parameter 'bcId' is set
    if (bcId == null) {
      throw new ApiException(400, "Missing the required parameter 'bcId' when calling catalogProductLog");
    }
    // verify the required parameter 'catalogId' is set
    if (catalogId == null) {
      throw new ApiException(400, "Missing the required parameter 'catalogId' when calling catalogProductLog");
    }
    // verify the required parameter 'feedLogId' is set
    if (feedLogId == null) {
      throw new ApiException(400, "Missing the required parameter 'feedLogId' when calling catalogProductLog");
    }
    // verify the required parameter 'accessToken' is set
    if (accessToken == null) {
      throw new ApiException(400, "Missing the required parameter 'accessToken' when calling catalogProductLog");
    }
    // create path and map variables
    String localVarPath = "/open_api/v1.3/catalog/product/log/";
    ...
    localVarQueryParams.addAll(apiClient.parameterToPairs("", "bc_id", bcId));
    localVarQueryParams.addAll(apiClient.parameterToPairs("", "catalog_id", catalogId));
    localVarQueryParams.addAll(apiClient.parameterToPairs("", "feed_log_id", feedLogId));
   ...
   * @throws ApiException if fails to make API call
   */
  public Response catalogSetDelete(String accessToken, SetDeleteBody body) throws ApiException, SDKException, SDKExceptionForEvent {
    Object localVarPostBody = body;
    // verify the required parameter 'accessToken' is set
    if (accessToken == null) {
      throw new ApiException(400, "Missing the required parameter 'accessToken' when calling catalogSetDelete");
    }
    // create path and map variables
    String localVarPath = "/open_api/v1.3/catalog/set/delete/";
   ...
   * @param bcId  (required)
   * @param accessToken Authorized access token. For details, see [Authentication](https://ads.tiktok.com/marketing_api/docs?id&#x3D;1738373164380162). (required)
   * @param productSetId  (optional)
   * @param returnProductCount  (optional, default to true)
   * @return InlineResponse200
   * @throws ApiException if fails to make API call
   */
  public Response catalogSetGet(String catalogId, String bcId, String accessToken, String productSetId, Boolean returnProductCount) throws ApiException, SDKException, SDKExceptionForEvent {
    Object localVarPostBody = null;
    // verify the required parameter 'catalogId' is set
    if (catalogId == null) {
      throw new ApiException(400, "Missing the required parameter 'catalogId' when calling catalogSetGet");
    }
    // verify the required parameter 'bcId' is set
    if (bcId == null) {
      throw new ApiException(400, "Missing the required parameter 'bcId' when calling catalogSetGet");
    }
    // verify the required parameter 'accessToken' is set
    if (accessToken == null) {
      throw new ApiException(400, "Missing the required parameter 'accessToken' when calling catalogSetGet");
    }
    // create path and map variables
    String localVarPath = "/open_api/v1.3/catalog/set/get/";
    ...
    localVarQueryParams.addAll(apiClient.parameterToPairs("", "return_product_count", returnProductCount));
   ...
   * @throws ApiException if fails to make API call
   */
  public Response catalogSetUpdate(String accessToken, SetUpdateBody body) throws ApiException, SDKException, SDKExceptionForEvent {
    Object localVarPostBody = body;
    // verify the required parameter 'accessToken' is set
    if (accessToken == null) {
      throw new ApiException(400, "Missing the required parameter 'accessToken' when calling catalogSetUpdate");
    }
    // create path and map variables
    String localVarPath = "/open_api/v1.3/catalog/set/update/";
   ...
   * @throws ApiException if fails to make API call
   */
  public Response catalogVideoDelete(String accessToken, VideoDeleteBody body) throws ApiException, SDKException, SDKExceptionForEvent {
    Object localVarPostBody = body;
    // verify the required parameter 'accessToken' is set
    if (accessToken == null) {
      throw new ApiException(400, "Missing the required parameter 'accessToken' when calling catalogVideoDelete");
    }
    // create path and map variables
    String localVarPath = "/open_api/v1.3/catalog/video/delete/";
   ...
   * @param catalogId  (required)
   * @param accessToken Authorized access token. For details, see [Authentication](https://ads.tiktok.com/marketing_api/docs?id&#x3D;1738373164380162). (required)
   * @param catalogVideoIds  (optional)
   * @param page  (optional, default to 1)
   * @param pageSize  (optional, default to 10)
   * @return InlineResponse200
   * @throws ApiException if fails to make API call
   */
  public Response catalogVideoGet(String bcId, String catalogId, String accessToken, List<String> catalogVideoIds, Long page, Long pageSize) throws ApiException, SDKException, SDKExceptionForEvent {
    Object localVarPostBody = null;
    // verify the required parameter 'bcId' is set
    if (bcId == null) {
      throw new ApiException(400, "Missing the required parameter 'bcId' when calling catalogVideoGet");
    }
    // verify the required parameter 'catalogId' is set
    if (catalogId == null) {
      throw new ApiException(400, "Missing the required parameter 'catalogId' when calling catalogVideoGet");
    }
    // verify the required parameter 'accessToken' is set
    if (accessToken == null) {
      throw new ApiException(400, "Missing the required parameter 'accessToken' when calling catalogVideoGet");
    }
    // create path and map variables
    String localVarPath = "/open_api/v1.3/catalog/video/get/";
    ...
    localVarQueryParams.addAll(apiClient.parameterToPairs("", "bc_id", bcId));
    localVarQueryParams.addAll(apiClient.parameterToPairs("", "catalog_id", catalogId));
    localVarQueryParams.addAll(apiClient.parameterToPairs("multi", "catalog_video_ids", catalogVideoIds));
    localVarQueryParams.addAll(apiClient.parameterToPairs("", "page", page));
    localVarQueryParams.addAll(apiClient.parameterToPairs("", "page_size", pageSize));
